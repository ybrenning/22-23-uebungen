...
\begin{document}
    ...
    \begin{enumerate}[1.]
        ...
        Es handelt sich um ein Laplace-Experiment, da die Wahrscheinlichkeit jedes Elementarereignisses (d.h. die Wahrscheinlichkeit f"ur einen bestimmten
        Wochentag) immer gleich ist, genau genommen $ \mathbb{P}(\omega) = \frac{1}{|\Omega|} = \frac{1}{7} $.

        \item

        Es handelt sich um ein Laplace-Experiment, da beim einmaligen Ziehen jedes Los die gleiche Wahrscheinlichkeit hat, gezogen zu werden, n"amlich $ \frac{1}{120} $.

        \item

        Es handelt sich nicht um ein Laplace-Experiment, da es nicht gleichwahrscheinlich ist, ``vorne'' oder ``hinten'' ein Plattfu{\ss} zu kriegen. 
    \end{enumerate}
    ...
    \begin{enumerate}[(a)]
        ...
        \begin{enumerate}[i.]
            ...
            $ \displaystyle \mathbb{P}(A) = 1 - \mathbb{P}(A^{\mathsf{c}}) = 1 - (\frac{5}{6})^6 \approx 0.665 $
        \end{enumerate}
