...
\begin{document}
    ...
    \begin{enumerate}
        ...
        Somit ergibt sich der Wertebereich $ X \in \{3, 1, -0.60, -1\} $.
        \begin{flalign*}
        ...
        \end{flalign*}
        \begin{flalign*}
            \mathbb{P}(X = -0.60) & = \frac{7}{8} \cdot \frac{6}{7} \cdot \frac{1}{6} && \\
            & = \frac{42}{336}
        \end{flalign*}
        \begin{flalign*}
        ...
        \begin{flalign*}
            \mathbb{E}(X) & = \mathbb{P}(X = 3) \cdot 3 + \mathbb{P}(X = 1) \cdot 1 + \mathbb{P}(X = -0.60) \cdot (-0.60) + \mathbb{P}(X = -1) \cdot (-1) && \\
        ...
        \begin{flalign*}
            \mathbb{E}(X) & = 0 && \\
            \Rightarrow 0 & = \frac{4 - e}{8} + \frac{2 - e}{8} + \frac{0.40 - e}{8} + \frac{-5e}{8} && \\
            & = \frac{6.40 - 8e}{8} && \\
            \Leftrightarrow 0 & = 6.40 - 8e && \\
            0.8 & = e 
        \end{flalign*}
    ...
    \begin{equation*}
    \begin{split}
        \text{Var}(X) & = \mathbb{P}(X = 3) \cdot (3 + 0.2) + \mathbb{P}(X = 1) \cdot (1 + 0.2) \\
        & + \mathbb{P}(X = -0.60) \cdot (-0.60 + 0.2) + \mathbb{P}(X = -1) \cdot (-1 + 0.2) \\
        & = \frac{3.2}{8} + \frac{1.2}{8} - \frac{0.40}{8} - \frac{5 \cdot (-0.8)}{8} \\
        & = 1
    \end{split}
    \end{equation*}
    \end{enumerate}
